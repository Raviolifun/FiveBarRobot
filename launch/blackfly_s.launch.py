...
camera_params = {
    ...
    #'AutoExposureExposureTimeUpperLimit': 200,
    # 'device_link_throughput_limit': 380000000,
    # ---- to reduce the sensor width and shift the crop
    "image_width": 384,  # 720 max
    "image_height": 480,  # 480 max
    "offset_x": 148,
    #'offset_y': 0,
    "frame_rate_auto": "Off",
    "frame_rate": 60.0,
...
def generate_launch_description():
    ...
    serial_arg = LaunchArg("serial", default_value="'18384126'", description="serial number")
    ...
    node = Node(
        ...
        parameters=[
            camera_params,
            {"parameter_file": config_dir + "blackfly_s.cfg", "serial_number": [LaunchConfig("serial")]},
        ],
